...
describe.only('testing the functionalitly of Reduce', () => {
  ...
  it('it should return a tally using the object data structure ', () => {
  ...
  it('it should return a flattened array', () => {
    const flat = flattenArray([[1, 2, 3], [4, 5, 6], [7, 8, 9]]);
    expect(flat).to.be.equalTo([1, 2, 3, 4, 5, 6, 7, 8, 9]);
  });
  it('should transform and array of objects to accessible via id', () => {
    const peopleArray = [
